                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="shoping__cart__quantity">
                                        ...
                                        <input class="styling" type="submit" name="submitupdate" value="Cập nhật lại"/>
                                        </form>
                                    </td>
                                    ...
                                    <td class="shoping__cart__item__close">
                                        ...
                                        <td><a onclick ="return confirm('Bạn có muốn xóa?')" href="?delid=<?php echo $result['cartId']?>">Xoá</a></td>
                                    </td>
                                </tr>
                            <?php 
                            $sub_total += $total;
                ...
                <div class="col-lg-6">
                    <div class="shoping__continue">
                        <div class="shoping__discount">
                            <h5>Mã giảm giá</h5>
                            <form action="" method="post">
                                <input type="text" name="codediscount" placeholder="Nhập code ở đây...">
                                <button type="submit" name="discount" class="site-btn">Áp dụng ngay</button>
                    ...
                    <div class="shoping__checkout">
                        ...
                        <ul>
                            <li>Thành Tiền <span><?php  
                                    ...
                                    echo $fm->format_currency($sub_total) .' VNĐ' ;
                            ...
                            <li>Giảm giá (<?php echo $result['code']?>) 
                                ...
                                <?php 
                                 ...
                                 ?>
                                <button type="submit" name="undiscount" class="stylinggg">Xoá</button>
                                <?php 
                                } ?>
                            </li>
                            ...
                            <li>Tổng tiền <span><?php  
                                     ...
                                     echo $fm->format_currency($alltotal).'VNĐ ';
                                    Session::set('qtt',$sl);
