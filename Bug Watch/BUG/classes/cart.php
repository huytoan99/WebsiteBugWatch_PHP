	...
	class cart
	{
		...
		public function AddToCart($name,$quantity){
			...
			$image = $result["image"];
 			...
 			$check = "SELECT * FROM tbl_cart WHERE productName = '$productName' AND ssId = '$session_id'";
 			...
 			if($check_cart){
 				...
 				$query_insert = "INSERT INTO tbl_cart(productName, ssId, price, quantity, image) VALUES ('$productName','$session_id','$price','$quantity','$image')";
