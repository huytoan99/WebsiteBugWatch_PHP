...
<section class="product-details spad">
    ...
    <div class="blog__details__text">
        ...
        <center><h4>Cảm ơn bạn đã mua hàng tại BUG WATCH.</h4></center>
        <?php 
            }
        }
         ?>
        ...
        ?>
        <h5>(Đơn hàng có giá trị đổi trả sau 24h. Vui lòng giữ lại mã hóa đơn này)<br> <br>
        Vui lòng <a href="bill.php">click here</a> để xem thông tin chi tiết đơn hàng
        </h5>
        <h5 class="htest">Chân thành cảm ơn ☺</h5>
        <br>
        <h5>Your Friends at BUG Watch</h5>
        </center>
