...
<head>
    ...
    <link rel="icon" href="img/watch.png" type="image/x-icon">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__left">
                            <ul>
                                <li><i class="fa fa-envelope"></i> contact@bugwatch.com</li>
                                <li>Miễn phí giao hàng cho hóa đơn từ 10.099.000 VNĐ</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="header__logo">
                        <a href="./index.php"><img src="img/4.png" alt="" ></a>
                    </div>
                </div>
                <div class="col-lg-6">
