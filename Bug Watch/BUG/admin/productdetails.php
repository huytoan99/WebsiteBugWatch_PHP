...
<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['addsize'])){
        ...
        $insert_product = $prod->add_Size_Product($name,$quantity);
    }
      ...
      <form action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <input type="text" name="productName" class="form-control" placeholder="Nhập tên sản phẩm" value="<?php echo $result_prod['productName'] ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <label> Giá </label>
                <input type="text" name="price" class="form-control" placeholder="Nhập giá" value="<?php echo $result_prod['price'] ?>">
            </div>
            <div class="form-group">

                <label> Mô Tả </label>
                <input type="text" name="description" class="form-control" placeholder="Nhập mô tả sản phẩm" value="<?php echo $result_prod['description'] ?>">
            </div>
            <div class="form-group">
    ...
    <div class="card-body">     
      <form action="" method="POST">
        ...
        <div class="rows">
          ...
          <div class=" col-8">
        <h3 class="m-0 font-weight-bold text-primary">&emsp;&emsp;&emsp;<?php echo $result_prod['productName'] ?></h3>
            
            <h5><?php echo $result_prod['description'] ?></h5><br>
            
            <h5 id="redd">Thương hiệu: <?php echo $result_prod['brandName'] ?></h5><br>          
             <h5 id="redd">Danh mục: <?php echo $result_prod['catName'] ?></h5><br>              
            <h3>Giá: <?php echo number_format($result_prod['price'],0,",",".") ." VNĐ"?></h3>
